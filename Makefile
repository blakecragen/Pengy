...
OFILES = gba.o font.o main.o images/garbage.o end.o images/rightDown.o images/leftDown.o images/rightStep.o images/leftStep.o images/trip.o images/fall.o images/igloo.o images/startBackground.o images/directions.o images/standing.o images/playBackground.o images/snowball.o
